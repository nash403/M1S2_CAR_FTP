...
public class FtpResponse {
	...
	public static final String file_status_ok = 150 + " File status okay; about to open data connection and start transfert.";
	...
	public static final String connect_error = 10061 +" Cannot connect to remote server. The connection is actively refused by the server.";
	public static String connect_refused = 10061 +" Cannot connect to remote server. The connection is actively refused by the server.";
